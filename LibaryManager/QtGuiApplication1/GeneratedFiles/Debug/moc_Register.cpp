...
QT_MOC_LITERAL(1, 9, 8), // "check_ok"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4) // "User"

    },
    "Register\0check_ok\0\0User"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->check_ok((*reinterpret_cast< User(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Register::*_t)(User );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Register::check_ok)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Register::check_ok(User _t1)
{
